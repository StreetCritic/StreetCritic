...
terrain = Terrain
way-rating = Way rating:

safety = Safety
comfort = Comfort
beauty = Beauty

menu-entry-about = About
menu-entry-sponsors = Sponsors
menu-entry-contact = Contact
menu-entry-tos = Terms of Use
...
context-menu-set-start = Route from here
context-menu-set-destination = Route to here
context-menu-add-waypoint = Add waypoint

location-search-recent-locations = Previous Locations:
...
way-points-via = Via:
way-points-to = To:
way-points-add = Add Waypoint
way-points-reverse = Reverse direction

way-preferences-title = Preferences:
`;
